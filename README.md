...
### Практика №2
про выборки [link](/материалы/выборки.md) <br/>
...
[поиск sota](/материалы/search.md) <br/>
...
### Практика №4
Ознакомление с устройством ViT. Можно использовать этот [пост](https://tintn.github.io/Implementing-Vision-Transformer-from-Scratch/) (или [ноутбук](https://github.com/tintn/vision-transformer-from-scratch/blob/main/vision_transformers.ipynb) того же автора)
### Практика №5
[![lesson2d](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1vGJTljjI2qi2kuITutSzs5s6KcOPU7tB?usp=sharing) устройство оптимайзера<br/>
...
[![lesson2с](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1RzJA-aSv_EDLB9nHUk7rD5nnxNbUxPn9?usp=sharing) обучение<br/>
